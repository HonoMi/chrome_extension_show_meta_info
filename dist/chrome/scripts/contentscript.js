...

{
    ...
    $(document).ready(function () {
        ...
        chrome.runtime.sendMessage({ method: "getQueryWords", url: url }, function (response) {
            var googleQueryWords = util.getQueryWordsFromDOM() !== "" ? util.getQueryWordsFromDOM() : response;
            if (googleQueryWords === "") {
                return;
            }
            ...
            chrome.runtime.sendMessage({ method: "storeQueryWords", urls: urls, googleQueryWords: googleQueryWords }, function () {});
        });
    });
    ...
    chrome.runtime.sendMessage({ method: "getQueryWords", url: url }, function (response) {
        ...
        // meta情報を表示するdiv
        var div = $("<div>").attr("id", "show_google_query_words_meta").attr("class", "meta_parent");
        ...
        $("#show_google_query_words_meta").on("mouseover", function () {
            ...
            setTimeout(function () {
                $("#hide").attr("id", "show_google_query_words_meta");
            }, 5000);
        });
    });
    // Css
